...
mejs.HtmlMediaElementShim = {
    create: function(a, b) {
        ...
        if (k.method == "native") {
            ...
            return this.createPlugin(k, c, e, j, h, l);
        else {
    ...
    createPlugin: function(a, b, c, d, e, g) {
        ...
        var f = 1, j = 1, h = "me_" + a.method + "_" + mejs.meIndex++, l = new mejs.PluginMediaElement(h,a.method,a.url), k = document.createElement("div"), m;
        l.tagName = c.tagName;
        ...
        case "flash":
            if (mejs.MediaFeatures.isIE) {
                ...
                k.innerHTML = '<embed id="' + h + '" name="' + h + '" play="true" loop="false" quality="high" bgcolor="#000000" wmode="transparent" allowScriptAccess="always" allowFullScreen="true" type="application/x-shockwave-flash" pluginspage="//www.macromedia.com/go/getflashplayer" src="' + b.pluginPath + b.flashName + '" flashvars="' + d.join("&") + '" width="' + f + '" height="' + j + '"></embed>';
            break;
        case "youtube":
    ...
    mejs.MediaElementPlayer.prototype = {
        ...
        init: function() {
            ...
            if (c.isiPad && a.options.iPadUseNativeControls || c.isiPhone && a.options.iPhoneUseNativeControls) {
                ...
                a.height = a.options[d + "Height"] > 0 || a.options[d + "Height"].toString().indexOf("%") > -1 ? a.options[d + "Height"] : a.media.style.height !== "" && a.media.style.height !== null ? a.media.style.height : a.$media[0].getAttribute("height") !== null ? a.$media.attr("height") : a.options["default" + c + "Height"];
        ...
        meReady: function(a, c) {
            ...
            if (!b.created) {
                ...
                b.media = a;
                b.domNode = c;
                if (!(d.isAndroid && b.options.AndroidUseNativeControls) && !(d.isiPad && b.options.iPadUseNativeControls) && !(d.isiPhone && b.options.iPhoneUseNativeControls)) {
                    ...
                    if (b.isVideo) {
                        if (mejs.MediaFeatures.hasTouch)
                            b.$media.bind("touchstart", function() {
                                if (b.controlsAreVisible)
                                    b.hideControls(false);
                                else
                                    b.controlsEnabled && b.showControls(false)
                            });
                        else {
                    ...
                    b.media.addEventListener("ended", function() {
                        ...
                        if (b.options.loop)
                            ...
                            !b.options.alwaysShowControls && b.controlsEnabled && b.showControls()
                    }, false);
                ...
                if (b.options.success)
                    typeof b.options.success == "string" ? window[b.options.success](b.media, b.domNode, b) : b.options.success(b.media, b.domNode, b)
            }
        },
        ...
        setPoster: function(a) {
            var c = this.container.find(".mejs-poster")
              , b = c.find("img");
            if (b.length == 0)
                b = f('<img width="100%" height="100%" />').appendTo(c);
            b.attr("src", a)
        },
        ...
        remove: function() {
            if (this.media.pluginType == "flash")
                ...
                this.media.pluginTyp == "native" && this.media.prop("controls", true);
...
(function(f) {
    f.extend(MediaElementPlayer.prototype, {
        buildprogress: function(a, c, b, d) {
            ...
            c.find(".mejs-time-total").bind("mouseenter", function() {
                r = true;
...
(function(f) {
    ...
    f.extend(MediaElementPlayer.prototype, {
        ...
        buildduration: function(a, c, b, d) {
        ...
        buildfullscreen: function(a, c, b, d) {
            if (a.isVideo) {
                ...
                f(document).bind("keydown", function(m) {
                    if ((mejs.MediaFeatures.hasTrueNativeFullScreen && mejs.MediaFeatures.isFullScreen() || e.isFullScreen) && m.keyCode == 27)
                        a.exitFullScreen()
                })
            }
        },
                    ...
                    if (mejs.MediaFeatures.hasTrueNativeFullScreen) {
                        ...
                        a.isInIframe && setTimeout(function b() {
                            if (a.isNativeFullScreen)
                                f(window).width() !== screen.width ? a.exitFullScreen() : setTimeout(b, 500)
                        }, 500)
...
(function(f) {
    ...
    f.extend(MediaElementPlayer.prototype, {
        ...
        renderContextMenu: function(a, c) {
            for (var b = this, d = "", e = b.options.contextMenuItems, g = 0, k = e.length; g < k; g++)
                if (e[g].isSeparator)
            ...
            b.contextMenu.find(".mejs-contextmenu-item").each(function() {
                ...
                o.click(function() {
                    typeof p.click != "undefined" && p.click(b);
                    b.contextMenu.hide()
                })
            });
            setTimeout(function() {
